...
// });
    ...
    Route::post('save-subjectcombinatiomaster',[SubjectCombination::class, 'create']);
    Route::get('view-subjectcombinatiomaster/{id}', [SubjectCombination::class, 'view']);
    Route::post('store-subjectcombinatiomaster', [SubjectCombination::class, 'store']);
    Route::post('delete-subjectcombinatiomaster', [SubjectCombination::class, 'subjectcombinatio_master_delete']); 
...
//     Route::get('add-student-registrations',[StudentRegistrationController::class,'add_student_registrations'])->name('add-student-registrations');
    ...
    Route::get('generate-due-chart-list/{id}/{session}',[FeesDuechart::class, 'generate_due_chart_list'])->name('generate-due-chart-list');
