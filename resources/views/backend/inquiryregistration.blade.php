                       ...
                       <div class="row">
                        <div class="col-md-6 form-group mb-3">
                           ...
                           <input
                             class="form-control"
                             id="searchenquiryno"
                             placeholder="" name="searchenquiryno" required
                        ...
                        <div class="col-md-4 form-group mb-3">
                         ...
                         <div class="col-md-4 form-group mb-3">
                           ...
                           <input
                             ...
                             id="eno"
                             type="text" disabled
                             placeholder="Enter your Enquiry no." name="eno" required value="{{$Userid}}"
                           /><input value="{{$Userid}}" type="hidden" name="enquiryno" id="enquiryno">
                           <span class="enquiryno_msg validation_err"></span>
                         </div>
                         ...
                         <div class="col-md-4 form-group mb-3">
                           ...
                           <input type="text" 
                             class="form-control"
                             id="formno"
                             placeholder="" name="formno" required 
                         ...
                         <div class="col-md-4 form-group mb-3">
                           ...
                           <input
                             ...
                             name="enquirydate" type="date" max="9999-12-31"
                           />
                         </div>
                        ...
                        <label for="city">City</label>
                         ...
                         <div class="col-md-3 form-group mb-3">
                           ...
                           <input
                             ...
                             id="pincode"
                             type="text"
                             placeholder="Enter your pin" name="pincode"
                           />
                         </div>
                         ...
                         <div class="col-md-6 form-group mb-3">
                           ...
                           <input type="text" name="caste" id="tags" class="form-control" >
                         ...
                         <div class="col-md-3 form-group mb-3">
                           <label for="presentlyschool">School</label>
                            <input class="form-control" id="presentlyschool" type="text" placeholder="Enter School name"  name="presentlyschool">
                         </div>
                         <div class="col-md-3 form-group mb-3">
                     ...
                     <div class="row">
                        <div class="row">
                          ...
                          <div class="col-md-6 form-group mb-3 answer">
                            ...
                            <input class="form-control" id="searchfather" placeholder="" name="searchfather" required />
                            <span class="validation_err"></span><span class="error_msg validation_err"></span>
                ...
                <tbody class="field_wrapper">
                  ...
                  <tr class="item">
                    <td>
                        ...
                        <input class="form-control" id="siblings_namesecond" type="text" placeholder="Enter name" name="siblings_namesecond[0]" value="">
           ...
           jQuery(document).ready(function($){
                ...
                var availableTags3 = [
                    <?php foreach($all_inquiry as $each2){ 
                         ...
                         // "<?php if(!empty($inq_str_data['fathermobile'])){ echo $inq_str_data['fathermobile']; }?>",
                         "<?php if(!empty($inq_str_data['enquiryno'])){ echo $inq_str_data['enquiryno']; }?>",
                   <?php } ?>
