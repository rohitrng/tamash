                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="m-0"><?php if (!empty($notificationData1['studentname_prefix'])) {
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php if (!empty($each_inq->application_for)) {
                                                                                echo $each_inq->application_for . ' ';
                                                                            } ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Father's Name </th>
                                                                        <td><?php if (!empty($notificationData1['fathername_prefix'])) {
                                                                                echo $notificationData1['fathername_prefix'] . ' ';
                                                                            } ?><?php if (!empty($notificationData1['student_father_name'])) {
                                                                                    echo $notificationData1['student_father_name'] . ' ';
                                                                                } ?> </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <!-- <th scope="row">2</th> -->
                                                                        <th>Mother's Name </th>
                                                                        <!-- <td><img class="rounded-circle m-0 avatar-sm-table" src="../../dist-assets/images/faces/1.jpg" alt="" /></td> -->
                                                                        <td><?php if (!empty($notificationData1['mothername_prefix'])) {
                                                                    ...
                                                                    <tr>
                                                                        <th>Address </th>
                                                                        <td><?php if (!empty($notificationData1['present_address'])) {
                                                                    ...
                                                                    <tr>
                                                                        <th>Address </th>
                                                                        <td><?php if (!empty($notificationData1['permanent_address'])) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php if (!empty($notificationData1['student_dob'])) {
                                                                            ...
                                                                            } ?> - <?php if (!empty($notificationData1['gender'])) {
...
'] . ' ';
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php if (!empty($notificationData1['present_school_name'])) {
                                                    ...
                                                    <div class="tab-pane fade" id="profileBasic" role="tabpanel" aria-labelledby="profile-basic-tab">
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td><?php if (!empty($notificationData1['siblings_name'])) {
                                                                                echo $notificationData1['siblings_name'] . ' ';
                                                                            } ?></td>
                                                                        ...
                                                                        <td><?php if (!empty($notificationData1[''])) {
                                                                                echo $notificationData1['siblings_bod'] . ' ';
                                                                            } ?></td>
                                                                    </tr>
                                                    ...
                                                    <div class="tab-pane fade" id="uploadDocument" role="tabpanel" aria-labelledby="upload-documents">
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <th>Require School Transport</th>
                                                                        <td><?php if (!empty($notificationData1['Name of Present Play School / Day Care (if any)'])) {
                                                                                echo $notificationData1['mobile_number'] . ' ';
                                                                            } ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Birth Certificate</th>
                                                                        <td><a href=""><?php if (!empty($notificationData1['birth_Certificate'])) {
                                                                                            echo $notificationData1['birth_Certificate'] . ' ';
                                                                                        } ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Transfer Certificate</th>
                                                                        <td><?php if (!empty($notificationData1['transfer_certificate'])) {
                                                                                echo $notificationData1['transfer_certificate'] . ' ';
                                                                            } ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>Address Proff</th>
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        <span>
                                                                                            <label class="form__choice-wrapper">
                                                                                                <label class="form-label text-primary" id="siblings_text" for="form1">Siblings <?php echo (!empty($siblings->remark)) ? $siblings->remark  : '' ?></lable>
                                                                                                    <input type="checkbox" disabled id="siblings" value="<?php if (!empty($siblings->remark)) {
                                                                                                                                                                $siblings = str_replace('%', '', $siblings->remark);
                                                                                                                                                                echo $siblings;
                                                                                                                                                            } else {
                                                                                                                                                                echo "";
                                                                                                                                                            } ?>">
...
inputDiscountedFees.value = discountedFees.toFixed(2); // Set the discounted fees as the value
...
inputFees.onchange = function() {
    // Calculate discounted fees when fees change
    var discountedFees = parseFloat(inputFees.value) * (1 - discountPercentage);
