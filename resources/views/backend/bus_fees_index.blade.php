            ...
            <div class="col-md-12">
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  >
                  @else
                  <form id="progress-form" class="p-4 progress-form" action="{{url('save-bus-fees-type')}}"  novalidate method="post">
                  @endif
                    <div class="row">
                      {{ csrf_field() }}
                      <!-- <div class="row"> -->
                      ...
                      <div class="col-md-3 form-group mb-3">
                        ...
                        <input
                            ...
                            type="text"
                            name="date"
                            @if(!empty($bus_fees) && isset($bus_fees->date))
                            value="{{ date('d-m-Y', strtotime($bus_fees->date)) }}"
                            @else
                            value=''
                            @endif
